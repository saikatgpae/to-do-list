...
!(function (t, e) { typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = e(require('@popperjs/core')) : typeof define === 'function' && define.amd ? define(['@popperjs/core'], e) : (t = typeof globalThis !== 'undefined' ? globalThis : t || self).bootstrap = e(t.Popper); }(this, ((t) => {
  function e(t) { if (t && t.__esModule) return t; const e = Object.create(null, { [Symbol.toStringTag]: { value: 'Module' } }); if (t) for (const i in t) if (i !== 'default') { const s = Object.getOwnPropertyDescriptor(t, i); Object.defineProperty(e, i, s.get ? s : { enumerable: !0, get: () => t[i] }); } return e.default = t, Object.freeze(e); } const i = e(t); const s = 'transitionend'; const n = (t) => { let e = t.getAttribute('data-bs-target'); if (!e || e === '#') { let i = t.getAttribute('href'); if (!i || !i.includes('#') && !i.startsWith('.')) return null; i.includes('#') && !i.startsWith('#') && (i = `#${i.split('#')[1]}`), e = i && i !== '#' ? i.trim() : null; } return e; }; const o = (t) => { const e = n(t); return e && document.querySelector(e) ? e : null; }; const r = (t) => { const e = n(t); return e ? document.querySelector(e) : null; }; const a = (t) => { t.dispatchEvent(new Event(s)); }; const l = (t) => !(!t || typeof t !== 'object') && (void 0 !== t.jquery && (t = t[0]), void 0 !== t.nodeType); const c = (t) => (l(t) ? t.jquery ? t[0] : t : typeof t === 'string' && t.length > 0 ? document.querySelector(t) : null); const h = (t) => { if (!l(t) || t.getClientRects().length === 0) return !1; const e = getComputedStyle(t).getPropertyValue('visibility') === 'visible'; const i = t.closest('details:not([open])'); if (!i) return e; if (i !== t) { const e = t.closest('summary'); if (e && e.parentNode !== i) return !1; if (e === null) return !1; } return e; }; const d = (t) => !t || t.nodeType !== Node.ELEMENT_NODE || !!t.classList.contains('disabled') || (void 0 !== t.disabled ? t.disabled : t.hasAttribute('disabled') && t.getAttribute('disabled') !== 'false'); const u = (t) => { if (!document.documentElement.attachShadow) return null; if (typeof t.getRootNode === 'function') { const e = t.getRootNode(); return e instanceof ShadowRoot ? e : null; } return t instanceof ShadowRoot ? t : t.parentNode ? u(t.parentNode) : null; }; const _ = () => {}; const g = (t) => { t.offsetHeight; }; const f = () => (window.jQuery && !document.body.hasAttribute('data-bs-no-jquery') ? window.jQuery : null); const p = []; const m = () => document.documentElement.dir === 'rtl'; const b = (t) => { let e; e = () => { const e = f(); if (e) { const i = t.NAME; const s = e.fn[i]; e.fn[i] = t.jQueryInterface, e.fn[i].Constructor = t, e.fn[i].noConflict = () => (e.fn[i] = s, t.jQueryInterface); } }, document.readyState === 'loading' ? (p.length || document.addEventListener('DOMContentLoaded', (() => { for (const t of p)t(); })), p.push(e)) : e(); }; const v = (t) => { typeof t === 'function' && t(); }; const y = (t, e, i = !0) => { if (!i) return void v(t); const n = ((t) => { if (!t) return 0; let{ transitionDuration: e, transitionDelay: i } = window.getComputedStyle(t); const s = Number.parseFloat(e); const n = Number.parseFloat(i); return s || n ? (e = e.split(',')[0], i = i.split(',')[0], 1e3 * (Number.parseFloat(e) + Number.parseFloat(i))) : 0; })(e) + 5; let o = !1; const r = ({ target: i }) => { i === e && (o = !0, e.removeEventListener(s, r), v(t)); }; e.addEventListener(s, r), setTimeout((() => { o || a(e); }), n); }; const w = (t, e, i, s) => { const n = t.length; let o = t.indexOf(e); return o === -1 ? !i && s ? t[n - 1] : t[0] : (o += i ? 1 : -1, s && (o = (o + n) % n), t[Math.max(0, Math.min(o, n - 1))]); }; const A = /[^.]*(?=\..*)\.|.*/; const T = /\..*/; const E = /::\d+$/; const C = {}; let k = 1; const L = { mouseenter: 'mouseover', mouseleave: 'mouseout' }; const O = new Set(['click', 'dblclick', 'mouseup', 'mousedown', 'contextmenu', 'mousewheel', 'DOMMouseScroll', 'mouseover', 'mouseout', 'mousemove', 'selectstart', 'selectend', 'keydown', 'keypress', 'keyup', 'orientationchange', 'touchstart', 'touchmove', 'touchend', 'touchcancel', 'pointerdown', 'pointermove', 'pointerup', 'pointerleave', 'pointercancel', 'gesturestart', 'gesturechange', 'gestureend', 'focus', 'blur', 'change', 'reset', 'select', 'submit', 'focusin', 'focusout', 'load', 'unload', 'beforeunload', 'resize', 'move', 'DOMContentLoaded', 'readystatechange', 'error', 'abort', 'scroll']); function I(t, e) { return e && `${e}::${k++}` || t.uidEvent || k++; } function S(t) { const e = I(t); return t.uidEvent = e, C[e] = C[e] || {}, C[e]; } function D(t, e, i = null) { return Object.values(t).find(((t) => t.callable === e && t.delegationSelector === i)); } function N(t, e, i) { const s = typeof e === 'string'; const n = s ? i : e || i; let o = j(t); return O.has(o) || (o = t), [s, n, o]; } function P(t, e, i, s, n) { if (typeof e !== 'string' || !t) return; let[o, r, a] = N(e, i, s); if (e in L) { const t = (t) => function (e) { if (!e.relatedTarget || e.relatedTarget !== e.delegateTarget && !e.delegateTarget.contains(e.relatedTarget)) return t.call(this, e); }; r = t(r); } const l = S(t); const c = l[a] || (l[a] = {}); const h = D(c, r, o ? i : null); if (h) return void (h.oneOff = h.oneOff && n); const d = I(r, e.replace(A, '')); const u = o ? (function (t, e, i) { return function s(n) { const o = t.querySelectorAll(e); for (let{ target: r } = n; r && r !== this; r = r.parentNode) for (const a of o) if (a === r) return F(n, { delegateTarget: r }), s.oneOff && $.off(t, n.type, e, i), i.apply(r, [n]); }; }(t, i, r)) : (function (t, e) { return function i(s) { return F(s, { delegateTarget: t }), i.oneOff && $.off(t, s.type, e), e.apply(t, [s]); }; }(t, r)); u.delegationSelector = o ? i : null, u.callable = r, u.oneOff = n, u.uidEvent = d, c[d] = u, t.addEventListener(a, u, o); } function x(t, e, i, s, n) { const o = D(e[i], s, n); o && (t.removeEventListener(i, o, Boolean(n)), delete e[i][o.uidEvent]); } function M(t, e, i, s) { const n = e[i] || {}; for (const o of Object.keys(n)) if (o.includes(s)) { const s = n[o]; x(t, e, i, s.callable, s.delegationSelector); } } function j(t) { return t = t.replace(T, ''), L[t] || t; } const $ = {
    ...
    _mergeConfigObj(t, e) {
      const i = l(e) ? W.getDataAttribute(e, 'config') : {}; return {
        ...this.constructor.Default, ...typeof i === 'object' ? i : {}, ...l(e) ? W.getDataAttributes(e) : {}, ...typeof t === 'object' ? t : {},
      };
    }
  ...
  } const K = (t, e = 'hide') => { const i = `click.dismiss${t.EVENT_KEY}`; const s = t.NAME; $.on(document, i, `[data-bs-dismiss="${s}"]`, (function (i) { if (['A', 'AREA'].includes(this.tagName) && i.preventDefault(), d(this)) return; const n = r(this) || this.closest(`.${s}`); t.getOrCreateInstance(n)[e](); })); }; class Q extends V {
  ...
  }K(Q, 'close'), b(Q); const X = '[data-bs-toggle="button"]'; class Y extends V {
    static get NAME() { return 'button'; }

    toggle() { this._element.setAttribute('aria-pressed', this._element.classList.toggle('active')); }

    static jQueryInterface(t) { return this.each((function () { const e = Y.getOrCreateInstance(this); t === 'toggle' && e[t](); })); }
  }$.on(document, 'click.bs.button.data-api', X, ((t) => { t.preventDefault(); const e = t.target.closest(X); Y.getOrCreateInstance(e).toggle(); })), b(Y); const U = {
  ...
  }; const G = { endCallback: null, leftCallback: null, rightCallback: null }; const J = { endCallback: '(function|null)', leftCallback: '(function|null)', rightCallback: '(function|null)' }; class Z extends R {
  ...
  } const tt = 'next'; const et = 'prev'; const it = 'left'; const st = 'right'; const nt = 'slid.bs.carousel'; const ot = 'carousel'; const rt = 'active'; const at = { ArrowLeft: st, ArrowRight: it }; const lt = {
    ...
    to(t) { const e = this._getItems(); if (t > e.length - 1 || t < 0) return; if (this._isSliding) return void $.one(this._element, nt, (() => this.to(t))); const i = this._getItemIndex(this._getActive()); if (i === t) return; const s = t > i ? tt : et; this._slide(s, e[t]); }

    dispose() { this._swipeHelper && this._swipeHelper.dispose(), super.dispose(); }

    _configAfterMerge(t) { return t.defaultInterval = t.interval, t; }

    _addEventListeners() { this._config.keyboard && $.on(this._element, 'keydown.bs.carousel', ((t) => this._keydown(t))), this._config.pause === 'hover' && ($.on(this._element, 'mouseenter.bs.carousel', (() => this.pause())), $.on(this._element, 'mouseleave.bs.carousel', (() => this._maybeEnableCycle()))), this._config.touch && Z.isSupported() && this._addTouchEventListeners(); }

    _addTouchEventListeners() { for (const t of U.find('.carousel-item img', this._element))$.on(t, 'dragstart.bs.carousel', ((t) => t.preventDefault())); const t = { leftCallback: () => this._slide(this._directionToOrder(it)), rightCallback: () => this._slide(this._directionToOrder(st)), endCallback: () => { this._config.pause === 'hover' && (this.pause(), this.touchTimeout && clearTimeout(this.touchTimeout), this.touchTimeout = setTimeout((() => this._maybeEnableCycle()), 500 + this._config.interval)); } }; this._swipeHelper = new Z(this._element, t); }
    ...
    _slide(t, e = null) {
      if (this._isSliding) return; const i = this._getActive(); const s = t === tt; const n = e || w(this._getItems(), i, s, this._config.wrap); if (n === i) return; const o = this._getItemIndex(n); const r = (e) => $.trigger(this._element, e, {
    ...
    static jQueryInterface(t) { return this.each((function () { const e = ht.getOrCreateInstance(this, t); if (typeof t !== 'number') { if (typeof t === 'string') { if (void 0 === e[t] || t.startsWith('_') || t === 'constructor') throw new TypeError(`No method named "${t}"`); e[t](); } } else e.to(t); })); }
  }$.on(document, 'click.bs.carousel.data-api', '[data-bs-slide], [data-bs-slide-to]', (function (t) { const e = r(this); if (!e || !e.classList.contains(ot)) return; t.preventDefault(); const i = ht.getOrCreateInstance(e); const s = this.getAttribute('data-bs-slide-to'); return s ? (i.to(s), void i._maybeEnableCycle()) : W.getDataAttribute(this, 'slide') === 'next' ? (i.next(), void i._maybeEnableCycle()) : (i.prev(), void i._maybeEnableCycle()); })), $.on(window, 'load.bs.carousel.data-api', (() => { const t = U.find('[data-bs-ride="carousel"]'); for (const e of t)ht.getOrCreateInstance(e); })), b(ht); const dt = 'show'; const ut = 'collapse'; const _t = 'collapsing'; const gt = '[data-bs-toggle="collapse"]'; const ft = { parent: null, toggle: !0 }; const pt = { parent: '(null|element)', toggle: 'boolean' }; class mt extends V {
    constructor(t, e) { super(t, e), this._isTransitioning = !1, this._triggerArray = []; const i = U.find(gt); for (const t of i) { const e = o(t); const i = U.find(e).filter(((t) => t === this._element)); e !== null && i.length && this._triggerArray.push(t); } this._initializeChildren(), this._config.parent || this._addAriaAndCollapsedClass(this._triggerArray, this._isShown()), this._config.toggle && this.toggle(); }
    ...
    static jQueryInterface(t) { const e = {}; return typeof t === 'string' && /show|hide/.test(t) && (e.toggle = !1), this.each((function () { const i = mt.getOrCreateInstance(this, e); if (typeof t === 'string') { if (void 0 === i[t]) throw new TypeError(`No method named "${t}"`); i[t](); } })); }
  }$.on(document, 'click.bs.collapse.data-api', gt, (function (t) { (t.target.tagName === 'A' || t.delegateTarget && t.delegateTarget.tagName === 'A') && t.preventDefault(); const e = o(this); const i = U.find(e); for (const t of i)mt.getOrCreateInstance(t, { toggle: !1 }).toggle(); })), b(mt); const bt = 'dropdown'; const vt = 'ArrowUp'; const yt = 'ArrowDown'; const wt = 'click.bs.dropdown.data-api'; const At = 'keydown.bs.dropdown.data-api'; const Tt = 'show'; const Et = '[data-bs-toggle="dropdown"]:not(.disabled):not(:disabled)'; const Ct = `${Et}.show`; const kt = '.dropdown-menu'; const Lt = m() ? 'top-end' : 'top-start'; const Ot = m() ? 'top-start' : 'top-end'; const It = m() ? 'bottom-end' : 'bottom-start'; const St = m() ? 'bottom-start' : 'bottom-end'; const Dt = m() ? 'left-start' : 'right-start'; const Nt = m() ? 'right-start' : 'left-start'; const Pt = {
    ...
    _getConfig(t) { if (typeof (t = super._getConfig(t)).reference === 'object' && !l(t.reference) && typeof t.reference.getBoundingClientRect !== 'function') throw new TypeError(`${bt.toUpperCase()}: Option "reference" provided type "object" without a required "getBoundingClientRect" method.`); return t; }
    ...
    static jQueryInterface(t) { return this.each((function () { const e = Mt.getOrCreateInstance(this, t); if (typeof t === 'string') { if (void 0 === e[t]) throw new TypeError(`No method named "${t}"`); e[t](); } })); }

    static clearMenus(t) { if (t.button === 2 || t.type === 'keyup' && t.key !== 'Tab') return; const e = U.find(Ct); for (const i of e) { const e = Mt.getInstance(i); if (!e || !1 === e._config.autoClose) continue; const s = t.composedPath(); const n = s.includes(e._menu); if (s.includes(e._element) || e._config.autoClose === 'inside' && !n || e._config.autoClose === 'outside' && n) continue; if (e._menu.contains(t.target) && (t.type === 'keyup' && t.key === 'Tab' || /input|select|option|textarea|form/i.test(t.target.tagName))) continue; const o = { relatedTarget: e._element }; t.type === 'click' && (o.clickEvent = t), e._completeHide(o); } }

    static dataApiKeydownHandler(t) { const e = /input|textarea/i.test(t.target.tagName); const i = t.key === 'Escape'; const s = [vt, yt].includes(t.key); if (!s && !i) return; if (e && !i) return; t.preventDefault(); const n = U.findOne(Et, t.delegateTarget.parentNode); const o = Mt.getOrCreateInstance(n); if (s) return t.stopPropagation(), o.show(), void o._selectMenuItem(t); o._isShown() && (t.stopPropagation(), o.hide(), n.focus()); }
  }$.on(document, At, Et, Mt.dataApiKeydownHandler), $.on(document, At, kt, Mt.dataApiKeydownHandler), $.on(document, wt, Mt.clearMenus), $.on(document, 'keyup.bs.dropdown.data-api', Mt.clearMenus), $.on(document, wt, Et, (function (t) { t.preventDefault(), Mt.getOrCreateInstance(this).toggle(); })), b(Mt); const jt = '.fixed-top, .fixed-bottom, .is-fixed, .sticky-top'; const $t = '.sticky-top'; const Ft = 'padding-right'; const zt = 'margin-right'; class Ht {
  ...
  } const qt = 'show'; const Bt = 'mousedown.bs.backdrop'; const Wt = {
  ...
  } const Kt = '.bs.focustrap'; const Qt = 'backward'; const Xt = { autofocus: !0, trapElement: null }; const Yt = { autofocus: 'boolean', trapElement: 'element' }; class Ut extends R {
    ...
    _handleFocusin(t) { const { trapElement: e } = this._config; if (t.target === document || t.target === e || e.contains(t.target)) return; const i = U.focusableChildren(e); i.length === 0 ? e.focus() : this._lastTabNavDirection === Qt ? i[i.length - 1].focus() : i[0].focus(); }

    _handleKeydown(t) { t.key === 'Tab' && (this._lastTabNavDirection = t.shiftKey ? Qt : 'forward'); }
  } const Gt = 'hidden.bs.modal'; const Jt = 'show.bs.modal'; const Zt = 'modal-open'; const te = 'show'; const ee = 'modal-static'; const ie = { backdrop: !0, focus: !0, keyboard: !0 }; const se = { backdrop: '(boolean|string)', focus: 'boolean', keyboard: 'boolean' }; class ne extends V {
    ...
    static jQueryInterface(t, e) { return this.each((function () { const i = ne.getOrCreateInstance(this, t); if (typeof t === 'string') { if (void 0 === i[t]) throw new TypeError(`No method named "${t}"`); i[t](e); } })); }
  }$.on(document, 'click.bs.modal.data-api', '[data-bs-toggle="modal"]', (function (t) { const e = r(this); ['A', 'AREA'].includes(this.tagName) && t.preventDefault(), $.one(e, Jt, ((t) => { t.defaultPrevented || $.one(e, Gt, (() => { h(this) && this.focus(); })); })); const i = U.findOne('.modal.show'); i && ne.getInstance(i).hide(), ne.getOrCreateInstance(e).toggle(this); })), K(ne), b(ne); const oe = 'show'; const re = 'showing'; const ae = 'hiding'; const le = '.offcanvas.show'; const ce = 'hidePrevented.bs.offcanvas'; const he = 'hidden.bs.offcanvas'; const de = { backdrop: !0, keyboard: !0, scroll: !1 }; const ue = { backdrop: '(boolean|string)', keyboard: 'boolean', scroll: 'boolean' }; class _e extends V {
    ...
    _initializeBackDrop() {
      const t = Boolean(this._config.backdrop); return new Vt({
        className: 'offcanvas-backdrop', isVisible: t, isAnimated: !0, rootElement: this._element.parentNode, clickCallback: t ? () => { this._config.backdrop !== 'static' ? this.hide() : $.trigger(this._element, ce); } : null,
      });
    }

    _initializeFocusTrap() { return new Ut({ trapElement: this._element }); }

    _addEventListeners() { $.on(this._element, 'keydown.dismiss.bs.offcanvas', ((t) => { t.key === 'Escape' && (this._config.keyboard ? this.hide() : $.trigger(this._element, ce)); })); }
  ...
  }$.on(document, 'click.bs.offcanvas.data-api', '[data-bs-toggle="offcanvas"]', (function (t) { const e = r(this); if (['A', 'AREA'].includes(this.tagName) && t.preventDefault(), d(this)) return; $.one(e, he, (() => { h(this) && this.focus(); })); const i = U.findOne(le); i && i !== e && _e.getInstance(i).hide(), _e.getOrCreateInstance(e).toggle(this); })), $.on(window, 'load.bs.offcanvas.data-api', (() => { for (const t of U.find(le))_e.getOrCreateInstance(t).show(); })), $.on(window, 'resize.bs.offcanvas', (() => { for (const t of U.find('[aria-modal][class*=show][class*=offcanvas-]'))getComputedStyle(t).position !== 'fixed' && _e.getOrCreateInstance(t).hide(); })), K(_e), b(_e); const ge = new Set(['background', 'cite', 'href', 'itemtype', 'longdesc', 'poster', 'src', 'xlink:href']); const fe = /^(?:(?:https?|mailto|ftp|tel|file|sms):|[^#&/:?]*(?:[#/?]|$))/i; const pe = /^data:(?:image\/(?:bmp|gif|jpeg|jpg|png|tiff|webp)|video\/(?:mpeg|mp4|ogg|webm)|audio\/(?:mp3|oga|ogg|opus));base64,[\d+/a-z]+=*$/i; const me = (t, e) => { const i = t.nodeName.toLowerCase(); return e.includes(i) ? !ge.has(i) || Boolean(fe.test(t.nodeValue) || pe.test(t.nodeValue)) : e.filter(((t) => t instanceof RegExp)).some(((t) => t.test(i))); }; const be = {
  ...
  }; const we = { entry: '(string|element|function|null)', selector: '(string|element)' }; class Ae extends R {
  ...
  } const Te = new Set(['sanitize', 'allowList', 'sanitizeFn']); const Ee = 'fade'; const Ce = 'show'; const ke = '.modal'; const Le = 'hide.bs.modal'; const Oe = 'hover'; const Ie = 'focus'; const Se = {
    AUTO: 'auto', TOP: 'top', RIGHT: m() ? 'left' : 'right', BOTTOM: 'bottom', LEFT: m() ? 'right' : 'left',
  }; const De = {
    allowList: be, animation: !0, boundary: 'clippingParents', container: !1, customClass: '', delay: 0, fallbackPlacements: ['top', 'right', 'bottom', 'left'], html: !1, offset: [0, 0], placement: 'top', popperConfig: null, sanitize: !0, sanitizeFn: null, selector: !1, template: '<div class="tooltip" role="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>', title: '', trigger: 'hover focus',
  }; const Ne = {
    allowList: 'object', animation: 'boolean', boundary: '(string|element)', container: '(string|element|boolean)', customClass: '(string|function)', delay: '(number|object)', fallbackPlacements: 'array', html: 'boolean', offset: '(array|string|function)', placement: '(string|function)', popperConfig: '(null|object|function)', sanitize: 'boolean', sanitizeFn: '(null|function)', selector: '(string|boolean)', template: 'string', title: '(string|element|function)', trigger: 'string',
  }; class Pe extends V {
    constructor(t, e) { if (void 0 === i) throw new TypeError("Bootstrap's tooltips require Popper (https://popper.js.org)"); super(t, e), this._isEnabled = !0, this._timeout = 0, this._isHovered = !1, this._activeTrigger = {}, this._popper = null, this._templateFactory = null, this._newContent = null, this.tip = null, this._setListeners(); }
    ...
    _createPopper(t) { const e = typeof this._config.placement === 'function' ? this._config.placement.call(this, t, this._element) : this._config.placement; const s = Se[e.toUpperCase()]; return i.createPopper(this._element, t, this._getPopperConfig(s)); }
    ...
    _setListeners() { const t = this._config.trigger.split(' '); for (const e of t) if (e === 'click')$.on(this._element, this.constructor.eventName('click'), this._config.selector, ((t) => this.toggle(t))); else if (e !== 'manual') { const t = e === Oe ? this.constructor.eventName('mouseenter') : this.constructor.eventName('focusin'); const i = e === Oe ? this.constructor.eventName('mouseleave') : this.constructor.eventName('focusout'); $.on(this._element, t, this._config.selector, ((t) => { const e = this._initializeOnDelegatedTarget(t); e._activeTrigger[t.type === 'focusin' ? Ie : Oe] = !0, e._enter(); })), $.on(this._element, i, this._config.selector, ((t) => { const e = this._initializeOnDelegatedTarget(t); e._activeTrigger[t.type === 'focusout' ? Ie : Oe] = e._element.contains(t.relatedTarget), e._leave(); })); } this._hideModalHandler = () => { this._element && this.hide(); }, $.on(this._element.closest(ke), Le, this._hideModalHandler), this._config.selector ? this._config = { ...this._config, trigger: 'manual', selector: '' } : this._fixTitle(); }
    ...
    _getConfig(t) { const e = W.getDataAttributes(this._element); for (const t of Object.keys(e))Te.has(t) && delete e[t]; return t = { ...e, ...typeof t === 'object' && t ? t : {} }, t = this._mergeConfigObj(t), t = this._configAfterMerge(t), this._typeCheckConfig(t), t; }

    _configAfterMerge(t) { return t.container = !1 === t.container ? document.body : c(t.container), typeof t.delay === 'number' && (t.delay = { show: t.delay, hide: t.delay }), t.originalTitle = this._element.getAttribute('title') || '', typeof t.title === 'number' && (t.title = t.title.toString()), typeof t.content === 'number' && (t.content = t.content.toString()), t; }
  ...
  }b(je); const $e = 'click.bs.scrollspy'; const Fe = 'active'; const ze = '[href]'; const He = {
    ...
    _maybeEnableSmoothScroll() { this._config.smoothScroll && ($.off(this._config.target, $e), $.on(this._config.target, $e, ze, ((t) => { const e = this._observableSections.get(t.target.hash); if (e) { t.preventDefault(); const i = this._rootElement || window; const s = e.offsetTop - this._element.offsetTop; if (i.scrollTo) return void i.scrollTo({ top: s, behavior: 'smooth' }); i.scrollTop = s; } }))); }
    ...
    _activateParents(t) { if (t.classList.contains('dropdown-item'))U.findOne('.dropdown-toggle', t.closest('.dropdown')).classList.add(Fe); else for (const e of U.parents(t, '.nav, .list-group')) for (const t of U.prev(e, '.nav-link, .nav-item > .nav-link, .list-group-item'))t.classList.add(Fe); }
  ...
  }$.on(window, 'load.bs.scrollspy.data-api', (() => { for (const t of U.find('[data-bs-spy="scroll"]'))Be.getOrCreateInstance(t); })), b(Be); const We = 'ArrowLeft'; const Re = 'ArrowRight'; const Ve = 'ArrowUp'; const Ke = 'ArrowDown'; const Qe = 'active'; const Xe = 'fade'; const Ye = 'show'; const Ue = '[data-bs-toggle="tab"], [data-bs-toggle="pill"], [data-bs-toggle="list"]'; const Ge = `.nav-link:not(.dropdown-toggle), .list-group-item:not(.dropdown-toggle), [role="tab"]:not(.dropdown-toggle), ${Ue}`; class Je extends V {
    ...
    _activate(t, e) { t && (t.classList.add(Qe), this._activate(r(t)), this._queueCallback((() => { t.getAttribute('role') === 'tab' ? (t.focus(), t.removeAttribute('tabindex'), t.setAttribute('aria-selected', !0), this._toggleDropDown(t, !0), $.trigger(t, 'shown.bs.tab', { relatedTarget: e })) : t.classList.add(Ye); }), t, t.classList.contains(Xe))); }

    _deactivate(t, e) { t && (t.classList.remove(Qe), t.blur(), this._deactivate(r(t)), this._queueCallback((() => { t.getAttribute('role') === 'tab' ? (t.setAttribute('aria-selected', !1), t.setAttribute('tabindex', '-1'), this._toggleDropDown(t, !1), $.trigger(t, 'hidden.bs.tab', { relatedTarget: e })) : t.classList.remove(Ye); }), t, t.classList.contains(Xe))); }

    _keydown(t) { if (![We, Re, Ve, Ke].includes(t.key)) return; t.stopPropagation(), t.preventDefault(); const e = [Re, Ke].includes(t.key); const i = w(this._getChildren().filter(((t) => !d(t))), t.target, e, !0); i && Je.getOrCreateInstance(i).show(); }
    ...
    _toggleDropDown(t, e) { const i = this._getOuterElement(t); if (!i.classList.contains('dropdown')) return; const s = (t, s) => { const n = U.findOne(t, i); n && n.classList.toggle(s, e); }; s('.dropdown-toggle', Qe), s('.dropdown-menu', Ye), s('.dropdown-item', Qe), i.setAttribute('aria-expanded', e); }
  ...
  }$.on(document, 'click.bs.tab', Ue, (function (t) { ['A', 'AREA'].includes(this.tagName) && t.preventDefault(), d(this) || Je.getOrCreateInstance(this).show(); })), $.on(window, 'load.bs.tab', (() => { for (const t of U.find('.active[data-bs-toggle="tab"], .active[data-bs-toggle="pill"], .active[data-bs-toggle="list"]'))Je.getOrCreateInstance(t); })), b(Je); const Ze = 'hide'; const ti = 'show'; const ei = 'showing'; const ii = { animation: 'boolean', autohide: 'boolean', delay: 'number' }; const si = { animation: !0, autohide: !0, delay: 5e3 }; class ni extends V {
